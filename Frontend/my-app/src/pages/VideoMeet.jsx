...
export default function VideoMeetComponent(){
    ...
    // Initialize screenAvailable with a default value
    ...
    const getPermissions = async () => {
        try{
            ...
            if(navigator.mediaDevices && typeof navigator.mediaDevices.getDisplayMedia === 'function'){
                ...
                console.log("Screen sharing is NOT available");
            }
            ...
            // Handle specific errors for video/audio permissions
    ...
    let getDislayMediaSuccess = (stream) => {
        console.log("Display media success")
        try {
            window.localStream.getTracks().forEach(track => track.stop())
        } catch (e) { console.log(e) }
    ...
    const handlePinVideo = (socketId) => {
        if (pinnedVideo === socketId) {
            setPinnedVideo(null);
        } else {
            setPinnedVideo(socketId);
        }
    }
    ...
    return (
        <div>
            {askForUsername === true ? (
               <div style={{
                    ...
                    <TextField
                        ...
                        sx={{
                            ...
                            '& .MuiOutlinedInput-root': {
                                ...
                                '&.Mui-focused fieldset': { borderColor: '#3a56d4' }
                            }
                        }}
                    />
                ...
                <div className={styles.buttonContainers}>
                        ...
                        {/* Add console.log to debug screenAvailable state */}
            ...
            {/* Conference view with pinning option */}
            <div className={styles.conferenceView}>
                {videos.map((video) => (
                    <div key={video.socketId} style={{ position: 'relative' }}>
                        {pinnedVideo === video.socketId ? (
                            // Pinned video (full screen)
                            <div className={styles.pinnedVideoOverlay}>
                                <video
                                ...
                                ></video>
                                <IconButton 
                                    onClick={() => handlePinVideo(video.socketId)}
                                    style={{
                                        position: 'absolute',
                                        top: '10px',
                                        right: '10px',
